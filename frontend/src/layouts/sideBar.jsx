...
export function AppSidebar() {
  ...
  const isSites = pathname === '/all-sites' || pathname.startsWith('/sites')
  const isSeoAudit = pathname === '/seo-audit'
  ...
  return (  
    <Sidebar>
      ...
      <SidebarHeader>
        <SidebarSection>
          <SidebarItem href="/all-sites" current={isSites} showIndicator>
          ...
          <SidebarItem href="/social" current={isSocial} showIndicator>
      ...
      <SidebarBody>
        <SidebarSection>
          <SidebarItem href="/seo-audit" current={isSeoAudit} showIndicator>
          ...
          <SidebarItem href="/team" current={isTeam} showIndicator>
          ...
          <SidebarItem href="/domains" current={isDomains} showIndicator>
      ...
      <SidebarFooter>
        ...
        <SidebarSection>
          <SidebarItem href="/workspace" current={isWorkspace} showIndicator>
